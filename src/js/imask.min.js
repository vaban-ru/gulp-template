!(function(t, e) {
  ...
  var u = function(t) {
    ...
    g = function(t, e) {
      if (!k(t)) return t;
      var n, u;
      if (e && 'function' == typeof (n = t.toString) && !k((u = n.call(t))))
        return u;
            ...
            Bt(
              ...
              Bt(
                wt({}, 'a', {
                  enumerable: !0,
                  get: function() {
                    wt(this, 'b', { value: 3, enumerable: !1 });
                  },
                }),
                { b: 2 },
              ),
    ...
    Ot = function(t) {
      return function(e, n, u) {
        ...
        return l <= s || '' == o
          ? a
          : ((i = l - s),
            (r = xt.call(o, Pt(i / o.length))).length > i &&
              (r = r.slice(0, i)),
            t ? a + r : r + a);
      };
    },
  ...
  Ft(
    ...
    Ft({ target: 'String', proto: !0 }, { repeat: xt }),
  ...
  var me = (function(t) {
    function e() {
      ...
      return (
        ...
        qt(this, Yt(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)))
      );
    }
    return (
      Ht(e, t),
            ...
            return e === n
              ...
              : (this._forEachBlocksInRange(e, n, function(e, n, i, r) {
                  ...
                  (a.stop = t._findStopBefore(n)),
                    ...
                    a instanceof ge && (a.blockIndex = n),
                    u.extend(a);
                }),
                u);
          },
  ...
  (me.DEFAULTS = { lazy: !0, placeholderChar: '_' }),
    (me.STOP_CHAR = '`'),
    (me.ESCAPE_CHAR = '\\'),
    (me.InputDefinition = ve),
    (me.FixedDefinition = ke),
    (he.MaskedPattern = me);
  var Ae = (function(t) {
    function e() {
      return Nt(this, e), qt(this, Yt(e).apply(this, arguments));
  ...
  var Ee = (function(t) {
    function e(t) {
      ...
      return (
        Nt(this, e),
        ((n = qt(this, Yt(e).call(this))).input = t),
        (n._handlers = {}),
        n
      );
    }
      ...
      zt(e, [
        ...
        },
        {
          ...
          value: function(t) {
            ...
            var r = Wt(Yt(e.prototype), '_appendCharRaw', this).call(
              this,
              t,
              n,
            );
  ...
  (Me.DEFAULTS = {
    ...
    (he.MaskedDynamic = Me);
  var xe = { MASKED: 'value', UNMASKED: 'unmaskedValue', TYPED: 'typedValue' };
  function Pe(t) {
    var e =
        arguments.length > 1 && void 0 !== arguments[1]
          ? arguments[1]
  ...
  (he.PIPE_TYPE = xe), (he.createPipe = Pe), (he.pipe = Oe);
  try {
    globalThis.IMask = he;
  } catch (t) {}
